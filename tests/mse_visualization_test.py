...
class TestMSEPlot(unittest.TestCase):
    ...
    def test_only_one_model(self):
        ...
        msevis.create_mse_json(
            "assets/jsons/evaluation_metrics/mse/model2.json",
            mse_values_model2,
            epochs_model2,
        )
        msevis.plot_mse_from_json(
            "assets/jsons/evaluation_metrics/mse/",
            "assets/images/evaluation_metrics/mse.png",
        )
    ...
    def test_more_models(self):
        ...
        epochs_model2 = [1, 2, 3, 4, 5]
        msevis.create_mse_json(
            "assets/jsons/evaluation_metrics/mse/model1.json",
            mse_values_model1,
            epochs_model1,
        )
        msevis.create_mse_json(
    ...
    def test_no_jsons(self):
        msevis.plot_mse_from_json("assets/jsons/evaluation_metrics/mse/", "assets/images/evaluation_metrics/mse.png")
