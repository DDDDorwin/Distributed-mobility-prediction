...
def make_general_pickle():
    ...
    normalized.to_pickle(r"D:\project\python\project_cs\data\grid_2\train.pkl")
    # Increment size
    size += length
...
def make_validate_pickle():
    ...
    normalized.columns = TableData.NORMALIZED_DTYPES.keys()
    # Make pickles with name: startIndex_endIndex.pkl
    normalized.to_pickle(r"D:\project\python\project_cs\data\grid_2\validate.pkl")
    # Increment size
    size += length
    print("Successfully pickled")
...
def make_test_pickle():
    ...
    normalized.columns = TableData.NORMALIZED_DTYPES.keys()
    # Make pickles with name: startIndex_endIndex.pkl
    normalized.to_pickle(r"D:\project\python\project_cs\data\grid_2\test.pkl")
    # Increment size
    size += length
    print("Successfully pickled")
